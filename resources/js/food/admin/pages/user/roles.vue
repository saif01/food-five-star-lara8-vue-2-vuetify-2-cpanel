  ...
  <div>
    ...
    <v-card elevation="0">
      <v-card-title class="justify-center">
        <v-row>
          <v-col cols="10">Role List</v-col>

          <v-col cols="2">
            <v-btn @click="addDataModel('Add New Role')" class="btn_add float-right" small>
            ...
            <table class="table table-bordered text-center table-striped">
              ...
              <tbody>
                <tr v-for="singleData in allData.data" :key="singleData.id">
                  <td>
                    {{ singleData.name }}
                    <v-chip small>{{ singleData.slug }}</v-chip>
                  </td>

                  <td class="text-center">
                    <div v-if="!singleData.used_role">
                      <v-btn
                        :disabled="singleData.name == 'Administrator'"
                    ...
                    <div v-else>
                      <span class="error--text">Already Assigned</span>
                    </div>
