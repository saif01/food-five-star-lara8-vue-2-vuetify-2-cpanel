      ...
      <v-container fill-height>
        <v-layout align-center justify-center>
          <v-flex class="form-size text-xs-center">
            <v-card>
              <v-card-title>{{ $t("reset__password") }}</v-card-title>

              <v-card-text v-if="!dataLoading">
                <form @submit.prevent="resetPassword()">
                  <v-text-field
                    v-model="form.current_pass"
                    :label="$t('current__password')"
                    :placeholder="$t('currentpass__placeholder')"
                    outlined
                    dense
                    required
                  ...
                  <v-text-field
                    ...
                    :placeholder="$t('newpass__placeholder')"
                    outlined
                    dense
                    required
                    prepend-inner-icon="mdi-lock-outline"
                  ...
                  <v-text-field
                    ...
                    :label="$t('confirm__password')"
                    :placeholder="$t('confirmpass__placeholder')"
                    outlined
                    dense
                    required
                    prepend-inner-icon="mdi-lock-outline"
