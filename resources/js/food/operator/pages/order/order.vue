  ...
  <div>
    <v-card elevation="0">
      ...
      <v-card-text>
        ...
        <div v-if="foodItems && !dataLoading">
          <div v-for="items in foodItems" :key="items.id">
        ...
        <data-not-available v-if="foodItems.length == 0 && !dataLoading" />
      </v-card-text>
    </v-card>
...
export default {
  ...
  async created() {
    await this.getFoodItemForOrder();
